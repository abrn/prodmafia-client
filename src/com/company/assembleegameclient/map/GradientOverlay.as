...
public class GradientOverlay extends Shape {
    ...
    private const gradientFill_:GraphicsGradientFill = new GraphicsGradientFill("linear", [0, 0], [0, 1], [0, 255], GraphicsUtil.getGradientMatrix(10, 10 * 60));

    private const gradientPath_:GraphicsPath = GraphicsUtil.getRectPath(0, 0, 10, 10 * 60);
