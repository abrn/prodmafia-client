...
public class CharacterStatusText extends Sprite implements IMapOverlayElement {
    ...
    public function CharacterStatusText(_arg_1:GameObject, color:uint, _arg_3:int, _arg_4:int = 0) {
        super();
        this.go_ = _arg_1;
        this.offset_ = new Point(0, -_arg_1.texture.height * (_arg_1.size_ * 0.01) * 5 - 20);
        this.color_ = color;
        this.lifetime_ = _arg_3;
        this.offsetTime_ = _arg_4;
        this.textDisplay = new BaseSimpleText(24, color);
