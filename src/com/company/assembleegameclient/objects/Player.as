...
public class Player extends Character {
    ...
    public function textNotification(_arg_1:String, _arg_2:int = 16777215, _arg_3:int = 2000, _arg_4:Boolean = false):void {
        var _local5:CharacterStatusText = null;
        if (_arg_4)
            map_.addObj(new LevelUpEffect(this, _arg_2 | 2130706432, 20), x_, y_);
        _local5 = new CharacterStatusText(this, _arg_2, _arg_3);
        _local5.setText(_arg_1);
        map_.mapOverlay_.addStatusText(_local5);
    }
