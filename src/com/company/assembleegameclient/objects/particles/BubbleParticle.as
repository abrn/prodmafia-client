...
public class BubbleParticle extends Particle {
      ...
      public static function create(param1:*, param2:uint, param3:Number, param4:Number, param5:Number, param6:Number, param7:Number) : BubbleParticle {
         var _local8:BubbleParticle = FreeList.getObject(param1) as BubbleParticle;
         if(!_local8) {
            _local8 = new BubbleParticle(param2,param3,param4,param5,param6,param7);
         }
         return _local8;
      }
      ...
      public function restart(param1:int, param2:int) : void {
         ...
         var _local4:Number = (param2 - param1) / 1000;
      ...
      override public function update(param1:int, param2:int) : Boolean {
         var _local3:Number = (param1 - this.startTime) / 1000;
