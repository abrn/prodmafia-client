...
public class SparkerParticle extends Particle {
      ...
      public function SparkerParticle(param1:int, param2:int, param3:int, param4:Point, param5:Point) {
         ...
         var _local6:* = param3;
         this.timeLeft_ = _local6;
         this.lifetime_ = _local6;
      ...
      override public function update(param1:int, param2:int) : Boolean {
         ...
         map_.addObj(new SparkParticle(100 * (z_ + 1),color_,10 * 60,z_,RandomUtil.plusMinus(1),-RandomUtil.plusMinus(1)),this.pathX_,this.pathY_);
         return true;
      }
   }
}
