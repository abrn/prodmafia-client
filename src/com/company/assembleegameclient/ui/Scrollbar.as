...
public class Scrollbar extends Sprite {
    ...
    public function Scrollbar(_arg_1:int, _arg_2:int, _arg_3:Number = 1, _arg_4:Sprite = null) {
        backgroundFill_ = new GraphicsSolidFill(0xffffff, 1);
    ...
    public function setIndicatorSize(_arg_1:Number, _arg_2:Number, _arg_3:Boolean = true):void {
        var _local4:int = _arg_2 == 0 ? this.indicatorRect_.height : int(_arg_1 / _arg_2 * this.indicatorRect_.height);
    ...
    public function setPos(_arg_1:Number):void {
        if (_arg_1 == Infinity || _arg_1 == -Infinity) {
            return;
        }
    ...
    public function resize(_arg_1:int, _arg_2:int, _arg_3:Number = 1):void {
        ...
        this.height_ = _arg_2;
        this.speed_ = _arg_3;
        var _local5:int = this.width_ * 0.75;
        this.indicatorRect_ = new Rectangle(0, _local5 + 5, this.width_, this.height_ - _local5 * 2 - 10);
        var _local4:Graphics = this.background_.graphics;
        _local4.clear();
        _local4.beginFill(0x545454, 1);
        _local4.drawRect(this.indicatorRect_.x, this.indicatorRect_.y, this.indicatorRect_.width, this.indicatorRect_.height);
        _local4.endFill();
        drawArrow(_local5, this.width_, this.upArrow_.graphics);
        this.upArrow_.rotation = -90;
        this.upArrow_.x = this.width_ / 2;
        this.upArrow_.y = _local5 / 2;
        drawArrow(_local5, this.width_, this.downArrow_.graphics);
        this.downArrow_.x = this.width_ / 2;
        this.downArrow_.y = this.height_ - _local5 / 2;
    ...
    private function getSprite(_arg_1:Function):Sprite {
        ...
        _local2.addEventListener("mouseDown", _arg_1, false, 0, true);
        _local2.addEventListener("rollOver", this.onRollOver, false, 0, true);
        _local2.addEventListener("rollOut", this.onRollOut, false, 0, true);
        return _local2;
    }
    ...
    protected function onAddedToStage(_arg_1:Event):void {
        if (this.target_ != null) {
            ...
            WebMain.STAGE.addEventListener("mouseWheel", this.onMouseWheel, false, 0, true);
        }
    }
    ...
    private function onArrowFrame(_arg_1:Event):void {
        ...
        var _local4:Number = (_local2 - this.lastUpdateTime_) / 1000;
        var _local3:Number = (this.height_ - this.width_ * 3) * _local4 * this.change_;
        this.setPos((this.posIndicator_.y + _local3 - this.indicatorRect_.y) / (this.indicatorRect_.height - this.posIndicator_.height));
