...
internal class EditBoard extends Sprite {
    ...
    function EditBoard(_arg_1:String) {
        ...
        _local3.beginFill(0);
        _local3.drawRect(0, 0, 400, 400);
        _local3.endFill();
        this.mainSprite_.addChild(_local2);
        this.mainSprite_.mask = _local2;
        addChild(this.mainSprite_);
        this.boardText_ = new BaseSimpleText(16, 0xb3b3b3, true, 400, 400);
        ...
        this.w_ = 426;
        this.cancelButton_ = new DeprecatedTextButton(14, "Frame.cancel", 2 * 60);
        ...
        this.saveButton_ = new DeprecatedTextButton(14, "EditGuildBoard.save", 2 * 60);
