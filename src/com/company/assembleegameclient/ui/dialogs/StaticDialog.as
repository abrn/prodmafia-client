...
public class StaticDialog extends Sprite {
    ...
    protected function initText(_arg_1:String):void {
        ...
        var _local2:StaticStringBuilder = new StaticStringBuilder(_arg_1).setPrefix("<p align=\"center\">").setPostfix("</p>");
    ...
    private function makeNonNullButtons():void {
        if (this.leftButtonKey != null) {
            this.leftButton = new DeprecatedTextButton(16, this.leftButtonKey, 2 * 60, true);
            this.leftButton.addEventListener("click", this.onLeftButtonClick);
        }
        if (this.rightButtonKey != null) {
            this.rightButton = new DeprecatedTextButton(16, this.rightButtonKey, 2 * 60, true);
