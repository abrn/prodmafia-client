package io.decagames.rotmg.classes {
    ...
    public class NewClassUnlockNotification extends Sprite {
        ...
        private function createCharacter(): void {
            ...
            var _local5: int = ObjectLibrary.playerChars_.length;
            var _local2: int = this._objectTypes.shift();
            while (_local4 < _local5) {
                _local1 = ObjectLibrary.playerChars_[_local4];
                _local3 = _local1.@type;
                if (_local2 == _local3) {
                    this._newClass = new Bitmap(this.getImageBitmapData(_local1));
                    break;
                }
                _local4++;
            }
            if (this._newClass) {
                ...
                this._characterName.text = _local1.@id;
        ...
        private function createCharacterBackground(): void {
            ...
            _local1.x = (192 - _local1.width) / 2;
            _local1.y = (192 - _local1.height) / 2 - 6;
        ...
        private function getImageBitmapData(_arg_1: XML): BitmapData {
            return SavedCharacter.getImage(null, _arg_1, 2, 0, 0, true, false);
        }
        ...
        private function createClassUnlockLabel(): void {
            var _local1: * = null;
            _local1 = new UILabel();
            _local1.text = "New Class Unlocked!";
            DefaultLabelFormat.notificationLabel(_local1, 18, 0xff00, "center", true);
            _local1.width = 192;
            _local1.x = (192 - _local1.width) / 2;
            _local1.y = 192 - _local1.height - 12;
            this._contentContainer.addChild(_local1);
        }
        
        private function createWhiteSplash(): void {
            this._whiteSplash = new Shape();
            var _local2: Graphics = this._whiteSplash.graphics;
            _local2.beginFill(0xffffff);
            _local2.drawRect(0, 0, 192, 192);
