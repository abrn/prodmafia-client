...
public class DailyQuestInfo extends Sprite {
    ...
    public static function hasAllItems(_arg_1:Vector.<int>, _arg_2:Vector.<int>):Boolean {
        var _local4:int = 0;
        var _local3:int = 0;
        var _local5:Vector.<int> = _arg_1.concat();
        var _local7:int = 0;
        var _local6:* = _arg_2;
        for each(_local4 in _arg_2) {
            _local3 = _local5.indexOf(_local4);
            if (_local3 >= 0) {
    ...
    public function show(_arg_1:DailyQuest, _arg_2:Vector.<int>):void {
        ...
        SlotsRendered.renderSlots(_arg_1.requirements, this._playerEquipment, "requirement", this.requirementsContainer, this.requirementsTopMargin, this.slotMargin, INFO_WIDTH, this.slots);
        SlotsRendered.renderSlots(_arg_1.rewards, this._playerEquipment, "reward", this.rewardsContainer, this.rewardsTopMargin, this.slotMargin, INFO_WIDTH, this.slots, _arg_1.itemOfChoice);
        this._completeButton.disabled = !_arg_1.completed ? !hasAllItems(_arg_1.requirements, _arg_2) : true;
    ...
    private function createQuestAvailable():void {
        ...
        DefaultLabelFormat.createLabelFormat(this.questAvailable, 12, 0xa3a3a3, "center", true);
    ...
    private function createRefreshInfo():void {
        ...
        DefaultLabelFormat.createLabelFormat(this.refreshInfo, 12, 0xff00, "center", true);
