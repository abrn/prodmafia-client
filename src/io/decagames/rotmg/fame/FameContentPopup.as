package io.decagames.rotmg.fame {
    ...
    public class FameContentPopup extends ModalPopup {
        ...
        public function setCharacterData(_arg_1: int, _arg_2: String, _arg_3: int, _arg_4: String, _arg_5: String, _arg_6: BitmapData): void {
            ...
            var _local7: Bitmap = new Bitmap(_arg_6);
        ...
        public function addDungeonLine(_arg_1: StatsLine): void {
            ...
            _arg_1.x = 6;
            _arg_1.y = this.dungeonLinesPosition * 27 - _local2;
        ...
        private function createStatsTab(): UITab {
            var _local4: * = null;
            var _local3: * = null;
            _local4 = new UITab("Statistics", true);
            ...
            var _local1: UIScrollbar = new UIScrollbar(338);
            _local1.mouseRollSpeedFactor = 1;
            _local1.scrollObject = _local4;
            _local1.content = this.statsContainer;
            _local2.addChild(_local1);
            _local1.x = this.contentInset.x + this.contentInset.width - 25;
            _local1.y = 7;
            _local3 = new Sprite();
            _local3.graphics.beginFill(0);
            _local3.graphics.drawRect(0, 0, 340, 342);
            _local3.x = this.statsContainer.x;
            _local3.y = this.statsContainer.y;
            this.statsContainer.mask = _local3;
        ...
        private function createDungeonTab(): UITab {
            var _local4: UITab = new UITab("Dungeons", true);
            var _local2: Sprite = new Sprite();
            ...
            _local1.mouseRollSpeedFactor = 1;
            _local1.scrollObject = _local4;
            _local1.content = this.dungeonContainer;
            _local2.addChild(_local1);
            _local1.x = this.contentInset.x + this.contentInset.width - 25;
            _local1.y = 7;
            ...
            _local3.graphics.beginFill(0);
            _local3.graphics.drawRect(0, 0, 340, 342);
            _local3.x = this.dungeonContainer.x;
            _local3.y = this.dungeonContainer.y;
            this.dungeonContainer.mask = _local3;
            _local2.addChild(_local3);
            _local4.addContent(_local2);
            return _local4;
        }
