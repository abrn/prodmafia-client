...
public class FeedTooltip extends ToolTip {
    ...
    private function createProgressIcon():void {
        ...
        _local3.graphics.beginFill(6341728, 1);
        _local3.graphics.drawRect(0, 0, 160, 4);
        _local3.graphics.endFill();
        this.progressIconContainer.addChild(_local3);
        var _local2:Sprite = new Sprite();
        _local2.graphics.beginFill(15305801, 1);
        _local2.graphics.drawRect(0, 0, 2 * 60, 4);
        _local2.graphics.endFill();
        this.progressIconContainer.addChild(_local2);
        _local1 = new UILabel();
        DefaultLabelFormat.petStatLabelLeft(_local1, 6341728);
        _local1.text = "MAX";
        _local1.x = 165;
        _local1.y = -5;
