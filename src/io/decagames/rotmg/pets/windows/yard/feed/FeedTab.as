...
public class FeedTab extends UITab {
    ...
    public function FeedTab(_arg_1:int) {
        ...
        var _local3:int = 100;
        this._feedFameButton.width = _local3;
        this._feedGoldButton.width = _local3;
        _local3 = 125;
        this._feedFameButton.y = _local3;
        this._feedGoldButton.y = _local3;
        _local2 = (_arg_1 - (this._feedGoldButton.width + this._feedFameButton.width + this.feedButtonsMargin)) / 2;
    ...
    public function updateFeedPower(_arg_1:int, _arg_2:Boolean):void {
        if (_arg_1 == 0 || _arg_2) {
            this.feedLabel.text = !_arg_2 ? "Select Items to Feed" : "Fully Maxed";
