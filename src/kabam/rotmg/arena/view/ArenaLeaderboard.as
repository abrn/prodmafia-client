...
public class ArenaLeaderboard extends Sprite {
    ...
    private function makeTabs():Vector.<ArenaLeaderboardTab> {
        var _local1:* = null;
        var _local3:* = null;
        var _local4:SignalWaiter = new SignalWaiter();
        var _local2:Vector.<ArenaLeaderboardTab> = new Vector.<ArenaLeaderboardTab>();
        var _local6:int = 0;
        var _local5:* = ArenaLeaderboardModel.FILTERS;
        for each(_local1 in ArenaLeaderboardModel.FILTERS) {
            _local3 = new ArenaLeaderboardTab(_local1);
            _local3.y = 70;
            _local3.selected.add(this.onSelected);
            _local2.push(_local3);
            _local4.push(_local3.readyToAlign);
            addChild(_local3);
        }
        _local4.complete.addOnce(this.alignTabs);
        return _local2;
    }
    ...
    private function makeTitle():StaticTextDisplay {
        ...
        _local1.setStringBuilder(new LineBuilder().setParams("ArenaLeaderboard.title"));
