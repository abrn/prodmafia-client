...
public class ImminentWaveCountdownClock extends Sprite {
    ...
    private const waveStartTimer:Timer = new Timer(25 * 60, 1);
    ...
    private function makeNextWaveText():StaticTextDisplay {
        ...
        _local1.setStringBuilder(new LineBuilder().setParams("ArenaCountdownClock.nextWave"));
    ...
    private function makeWaveText():StaticTextDisplay {
        ...
        _local1.setStringBuilder(new LineBuilder().setParams("ArenaCountdownClock.wave"));
        _local1.filters = [new DropShadowFilter(0, 0, 0, 1, 8, 8, 2)];
    ...
    private function makeWaveAsset():Class {
        var _local1:Class = new this.WaveAsset();
        this.waveStartContainer.addChild(_local1 as Sprite);
        return _local1;
    }
    ...
    private function makeStartText():StaticTextDisplay {
        ...
        _local1.setStringBuilder(new LineBuilder().setParams("ArenaCountdownClock.start"));
