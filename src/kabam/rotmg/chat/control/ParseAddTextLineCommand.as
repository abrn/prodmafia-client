...
public class ParseAddTextLineCommand extends Command {
    ...
    private function translateMessage():void {
        if (this.chatMessage.name == Parameters.CLIENT_CHAT_NAME
                || this.chatMessage.name == Parameters.SERVER_CHAT_NAME
                || this.chatMessage.name == Parameters.ERROR_CHAT_NAME
                || this.chatMessage.name == Parameters.HELP_CHAT_NAME
                || this.chatMessage.name.charAt(0) == "#")
