...
public class SpamFilter {
    ...
    private function returnAppropriatePatterns():Array {
        ...
        var _local3:int = 0;
        var _local4:int = 0;
        while (_local4 < this.newPatterns.length) {
            _local1 = "";
            _local3 = 0;
            while (_local3 < this.newPatterns[_local4].length) {
                if (this.newPatterns[_local4].charAt(_local3) != "\'" && this.newPatterns[_local4].charAt(_local3) != "\"") {
                    _local1 = _local1.concat(this.newPatterns[_local4].charAt(_local3));
                }
                _local3++;
            }
            this.newPatterns[_local4] = _local1;
            _local4++;
        }
