...
public class HandleNormalDeathCommand {
    ...
    private function trackDeath():void {
        var _local3:SavedCharacter = this.player.getCharById(this.death.charId_);
        var _local2:int = !!_local3 ? _local3.level() : 0;
        var _local1:TrackingData = new TrackingData();
        _local1.category = "killedBy";
        _local1.action = this.death.killedBy_;
