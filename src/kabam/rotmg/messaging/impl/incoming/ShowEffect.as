package kabam.rotmg.messaging.impl.incoming {
    ...
    public class ShowEffect extends IncomingMessage {
        ...
        override public function parseFromInput(param1: IDataInput): void {
            ...
            var offset: uint = param1.readUnsignedByte();
            if (offset && 64) {
        ...
        override public function toString(): String {
            var _local1: String = formatToString("SHOW_EFFECT", "effectType_", "targetObjectId_", "pos1_", "pos2_", "color_", "duration_").replace(/effectType_=\"\d+?\"/, "effectType_=\"" + this.effectType_ + "\" (" + this.EFFECT_DICT[this.effectType_] + ")");
            return _local1;
        }
    }
}
