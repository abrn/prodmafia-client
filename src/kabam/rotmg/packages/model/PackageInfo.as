...
public class PackageInfo extends GenericBoxInfo {
    ...
    private function loadImage(_arg_1:String, _arg_2:Loader, _arg_3:Function):void {
        _arg_2.contentLoaderInfo.addEventListener("complete", _arg_3);
        _arg_2.contentLoaderInfo.addEventListener("ioError", this.onIOError);
        _arg_2.contentLoaderInfo.addEventListener("securityError", this.onSecurityEventError);
        try {
    ...
    private function unbindLoaderEvents(_arg_1:Loader, _arg_2:Function):void {
        if (_arg_1 && _arg_1.contentLoaderInfo) {
            _arg_1.contentLoaderInfo.removeEventListener("complete", _arg_2);
            _arg_1.contentLoaderInfo.removeEventListener("ioError", this.onIOError);
            _arg_1.contentLoaderInfo.removeEventListener("securityError", this.onSecurityEventError);
        }
    }
