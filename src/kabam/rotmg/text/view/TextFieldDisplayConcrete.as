...
public class TextFieldDisplayConcrete extends Sprite implements TextFieldDisplay {
    ...
    private function setYToMiddle():void {
        ...
        var _local2:TextFormat = this.textField.getTextFormat();
        var _local1:Number = this.getSpecificXHeight(_local2);
        var _local3:Number = this.getSpecificVerticalSpace(_local2);
        this.textField.y = -(this.textField.height - (_local1 / 2 + _local3 + 2));
    }
