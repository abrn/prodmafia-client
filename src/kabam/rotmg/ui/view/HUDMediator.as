...
public class HUDMediator extends Mediator {
    ...
    private function startDraggingStatsAsset(_arg_1:StatsView):void {
        _arg_1.startDrag();
        _arg_1.addEventListener("mouseUp", this.onStatsMouseUp);
    }
    ...
    private function stopDraggingStatsAsset(_arg_1:Sprite):void {
        _arg_1.removeEventListener("mouseUp", this.onStatsMouseUp);
        _arg_1.addEventListener("mouseDown", this.onStatsMouseDown);
        _arg_1.stopDrag();
    }
    ...
    private function onStatsMouseUp(_arg_1:MouseEvent):void {
        var _local2:Sprite = StatsView(_arg_1.target);
    ...
    private function onStatsMouseDown(_arg_1:MouseEvent):void {
        var _local2:Sprite = Sprite(_arg_1.target);
        this.stats = _local2;
        _local2.removeEventListener("mouseDown", this.onStatsMouseDown);
        _local2.addEventListener("mouseUp", this.onStatsMouseUp);
        _local2.startDrag();
    }
}
}
