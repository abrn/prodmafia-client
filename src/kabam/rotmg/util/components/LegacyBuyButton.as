...
public class LegacyBuyButton extends BuyButton {
    ...
    public function LegacyBuyButton(_arg_1:String, _arg_2:int, _arg_3:int, _arg_4:int, _arg_5:Boolean = false, _arg_6:Boolean = false) {
        ...
        super();
        this.prefix = _arg_1;
        this.text = new TextFieldDisplayConcrete().setSize(_arg_2).setColor(!!_arg_6 ? 15544368 : 3552822).setBold(true);
        this.waiter.push(this.text.textChanged);
        var _local7:StringBuilder = _arg_1 != "" ? this.lineBuilder.setParams(_arg_1, {"cost": _arg_3.toString()}) : this.staticStringBuilder.setString(_arg_3.toString());
    ...
    override public function setPrice(_arg_1:int, _arg_2:int):void {
        ...
        if (this.price != _arg_1 || this.currency != _arg_2) {
            ...
            _local3 = this.prefix != "" ? this.lineBuilder.setParams(this.prefix, {"cost": _arg_1.toString()}) : this.staticStringBuilder.setString(_arg_1.toString());
